...
import type { QuizQuestion, QuizSectionProps, AnswersState } from '../types/quiz';

// Re-export types for backward compatibility
export type { QuizQuestion, QuizSectionProps, AnswersState } from '../types/quiz';
 ...
 * <!-- quiz-end -->
 */
export function parseQuizFromMarkdown(content: string): QuizQuestion[] | null {
 ...
 */
export function removeQuizFromContent(content: string): string {
...
const QuizSection: React.FC<QuizSectionProps> = ({ questions }) => {
  ...
  const correctCount = questions.reduce((count: number, q: QuizQuestion, idx: number) => {
