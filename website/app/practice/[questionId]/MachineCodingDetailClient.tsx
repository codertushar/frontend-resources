...
import { getQuestionById } from '../../../src/data/practice-questions/index';
...
interface MachineCodingDetailClientProps {
  questionId: string;
}

const MachineCodingDetail: React.FC<MachineCodingDetailClientProps> = ({ questionId }) => {
...
export { MachineCodingDetail as MachineCodingDetailClient };
