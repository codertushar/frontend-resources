...
import { Code2, Terminal, Search, X } from 'lucide-react';
import { getQuestions, getCategories, getQuestionCountByCategory, getQuestionCountByDifficulty } from '../../src/data/practice-questions/index';
...
const MachineCodingList: React.FC = () => {
  ...
  const filteredQuestions: Question[] = getQuestions(filters as any);
...
export { MachineCodingList as MachineCodingListClient };
